...
export default function Navbar() {
  ...
  return (
    <>
      <aside className="hidden lg:flex lg:w-80 lg:flex-col lg:border-r lg:border-slate-200/70 lg:bg-white/70 lg:px-6 lg:py-10 lg:text-slate-900 lg:shadow-sm lg:backdrop-blur dark:lg:border-slate-800/60 dark:lg:bg-slate-950/60 dark:lg:text-slate-100">
        <Link
          href="/"
        ...
        <nav className="mt-8 flex flex-1 flex-col gap-1 text-base">
