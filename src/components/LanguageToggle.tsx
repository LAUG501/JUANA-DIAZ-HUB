...
export default function LanguageToggle() {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={`pointer-events-none absolute -bottom-1 -right-1 inline-flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-bold ${
          language === "en"
            ? "bg-primary text-white dark:bg-secondary dark:text-slate-950"
            : "bg-secondary text-slate-900 dark:bg-primary dark:text-white"
        }`}
      >
        {language === "en" ? "EN" : "ES"}
      </span>
