    ...
    >
      {mounted ? (
        ...
        <span className="inline-flex items-center gap-2" aria-hidden>
          <span className="h-5 w-5 rounded-full bg-slate-200/70 dark:bg-slate-700/70" />
          <span className="h-4 w-24 rounded-full bg-slate-200/70 dark:bg-slate-700/70" />
        </span>
      )}
    </button>
  );
