...
export const communityPages: Record<string, CommunityPageContent> = {
  explore: {
    hero: {
      ...
      image: {
        src: "https://images.pexels.com/photos/2087014/pexels-photo-2087014.jpeg?auto=compress&cs=tinysrgb&w=1600&h=900&dpr=1",
        alt: "Colorful buildings and murals in Puerto Rico",
      },
      stats: [
  ...
  "event-calendar": {
    ...
    image: {
      src: "https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=1600&h=900&dpr=1",
      alt: "Outdoor festival crowd with stage lights",
    },
      actions: [
  ...
  forum: {
    ...
    image: {
      src: "https://images.pexels.com/photos/1181391/pexels-photo-1181391.jpeg?auto=compress&cs=tinysrgb&w=1600&h=900&dpr=1",
      alt: "Community members collaborating in a meeting",
    },
      stats: [
  ...
  "this-week": {
    ...
    sections: [
      ...
      },
      {
        ...
        cta: { label: "See full calendar", href: "/event-calendar/full" },
      },
    ],
    resources: [
  ...
  sitemap: {
    hero: {
      ...
      image: {
        src: "https://images.pexels.com/photos/1181355/pexels-photo-1181355.jpeg?auto=compress&cs=tinysrgb&w=1600&h=900&dpr=1",
        alt: "Designers planning a website sitemap",
      },
      actions: [
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Calendar overview", description: "At-a-glance planning with weekly spotlights.", href: "/event-calendar/full" },
      ...
      },
      {
        ...
        description: "Manage growth, insights, and personal preferences.",
        items: [
          { title: "Dashboard", description: "Task checklists and quick links.", href: "/dashboard" },
          { title: "Analytics", description: "Engagement metrics and performance.", href: "/analytics" },
          { title: "Settings", description: "Control notifications, language, and theme.", href: "/settings" },
          { title: "AI assistant", description: "Get bilingual answers and draft communications instantly.", href: "/ai-assistant" },
        ],
      },
    ],
    resources: [
